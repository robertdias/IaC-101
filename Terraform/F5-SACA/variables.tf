...
variable subnets {
  ...
  default = {
    ...
    "external"    = "10.99.1.0/24"
    "internal"    = "10.99.2.0/24"
    "vdms"        = "10.99.3.0/24"
    "inspect_ext" = "10.99.4.0/24"
    "inspect_int" = "10.99.5.0/24"
    "waf_ext"     = "10.99.6.0/24"
    "waf_int"     = "10.99.7.0/24"
    "application" = "10.99.10.0/24"
  }
}
...
variable f5_mgmt {
  ...
  type        = map(string)
  default = {
    f5vm01mgmt = "10.99.0.4"
    f5vm02mgmt = "10.99.0.5"
    f5vm03mgmt = "10.99.0.6"
    f5vm04mgmt = "10.99.0.7"
  }
}
...
variable f5_t1_ext {
  ...
  default = {
    f5vm01ext     = "10.99.1.4"
    f5vm01ext_sec = "10.99.1.11"
    f5vm02ext     = "10.99.1.5"
    f5vm02ext_sec = "10.99.1.12"
  }
}
...
variable f5_t1_int {
  ...
  default = {
    f5vm01int     = "10.99.2.4"
    f5vm01int_sec = "10.99.2.11"
    f5vm02int     = "10.99.2.5"
    f5vm02int_sec = "10.99.2.12"
  }
}
...
variable f5_t3_ext {
  ...
  default = {
    f5vm03ext     = "10.99.6.4"
    f5vm03ext_sec = "10.99.6.11"
    f5vm04ext     = "10.99.6.5"
    f5vm04ext_sec = "10.99.6.12"
  }
}
...
variable f5_t3_int {
  ...
  default = {
    f5vm03int     = "10.99.7.4"
    f5vm03int_sec = "10.99.7.11"
    f5vm04int     = "10.99.7.5"
    f5vm04int_sec = "10.99.7.12"
  }
}
...
variable app01ip {
  ...
  default     = "10.99.10.101"
}

# Example IPS private ips
variable ips01ext { default = "10.99.4.4" }
variable ips01int { default = "10.99.5.4" }
variable ips01mgmt { default = "10.99.0.8" }
...
variable licenses {
  type = map(string)
  default = {
    "license1" = "HAKBO-WUEAY-QIMPP-ADNIF-MRYWLIJ"
    "license2" = "UMOJH-WZIGW-CZEMI-MSQTF-IPTCECF"
  }
}
